...
async function solveCanvasBasedDrag(page, frame, promptText, apiKey, screenshotDir, enableScreenshot = false, maxAttempts = 2) {
    ...
    try {
        ...
        if (canvasElement) {
            ...
            const pageSourceX = analysis.source.x + canvasPositionInFrame.x + iframePosition.x;
            const pageSourceY = analysis.source.y + canvasPositionInFrame.y + iframePosition.y;
            const pageTargetX = analysis.target.x + canvasPositionInFrame.x + iframePosition.x;
            const pageTargetY = analysis.target.y + canvasPositionInFrame.y + iframePosition.y;
